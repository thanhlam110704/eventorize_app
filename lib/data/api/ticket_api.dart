...
class TicketApi {
  ...
  Future<Ticket> createTicket({
    ...
    required String startSaleDate,
    required String endSaleDate,
    required int price,
  ...
  Future<Ticket> editTicket({
    ...
    final data = {
      ...
      if (startSaleDate != null) 'start_sale_date': startSaleDate,
      if (endSaleDate != null) 'end_sale_date': endSaleDate,
