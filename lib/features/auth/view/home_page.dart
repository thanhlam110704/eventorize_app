      ...
      builder: (context, sessionManager, viewModel, _) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (sessionManager.errorMessage != null &&
              sessionManager.errorMessage != _lastSessionError) {
            ToastCustom.show(
              context: context,
            ...
            _lastSessionError = sessionManager.errorMessage;
            sessionManager.clearError();
          }
          if (viewModel.errorMessage != null &&
              viewModel.errorMessage != _lastViewModelError) {
            ToastCustom.show(
              context: context,
            ...
            _lastViewModelError = viewModel.errorMessage;
