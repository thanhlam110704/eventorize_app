...
class _PrivacyPolicyPageState extends State<PrivacyPolicyPage> {
  ...
  // 1. Chúng tôi là ai
  "Eventorize là nền tảng hỗ trợ tạo, khám phá và đăng ký sự kiện trực tuyến trên toàn cầu. "
      ...
      "Nếu bạn ở khu vực Châu Âu hoặc Anh, đại diện của chúng tôi là Eventorize Operations (IE) và Eventorize UK Limited.",

  // 2. Dịch vụ và vai trò của Eventorize
  "Eventorize cung cấp công cụ để người tổ chức tạo sự kiện và người dùng đăng ký tham gia. "
