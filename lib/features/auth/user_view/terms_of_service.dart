...
class _TOSPageState extends State<TOSPage> {
  ...
  final List<String> _contents = [
    "Khi sử dụng dịch vụ của Eventbrite, bạn đồng ý bị ràng buộc bởi các điều khoản, chính sách bảo mật và cookie của chúng tôi. "
        "Nếu bạn đại diện cho một tổ chức, bạn phải có thẩm quyền pháp lý để đồng ý thay mặt tổ chức đó. "
        "Tùy vào quốc gia bạn đang sinh sống, bạn sẽ ký hợp đồng với chi nhánh Eventbrite tương ứng như tại Mỹ, Châu Âu, Úc, Canada hoặc các quốc gia khác.",

    "Eventbrite cung cấp nền tảng để tạo, quảng bá và quản lý sự kiện. Chúng tôi không trực tiếp tổ chức hoặc sở hữu các sự kiện. "
        "Người tổ chức có toàn quyền kiểm soát và chịu trách nhiệm pháp lý về sự kiện, nội dung và phương thức thanh toán. "
        "Nếu sử dụng hệ thống thanh toán của Eventbrite, chúng tôi chỉ đóng vai trò trung gian xử lý giao dịch.",
...
Chào mừng bạn đến với Eventbrite! Chúng tôi hiểu rằng người tạo và tham gia sự kiện đều mong muốn sự kiện diễn ra an toàn và suôn sẻ — và chúng tôi cũng vậy.
...
Khi truy cập hoặc sử dụng dịch vụ của Eventbrite, bạn đồng ý với các điều khoản được nêu ra (bao gồm cả Chính sách quyền riêng tư và các chính sách, điều khoản liên quan khác). Đây là một hợp đồng ràng buộc giữa bạn và chúng tôi. Nếu bạn không đồng ý, vui lòng không sử dụng dịch vụ.

⚠️ Lưu ý quan trọng: Mục 9 của Điều khoản này có điều khoản ràng buộc trọng tài và từ bỏ quyền khởi kiện tập thể có thể ảnh hưởng đến quyền lợi pháp lý của bạn. Vui lòng đọc kỹ Mục 9.
''';
